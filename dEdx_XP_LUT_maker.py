...
# Last modification: 2024-11-12 by Tristan DARET
...
To compute the overall LUT, the script should be run for Dt = (310, 350) and RC = (112, 158), then hadd the 4 files.
"""
...
# The LUTs are computed for a given set of parameters (Dt, phi, d, RC, Z) and saved in a ROOT file within a TTree.
# These parameters correspond to the transverse diffusion coefficient, the track angle in a given pad, the impact 
# parameter of the track, the RC value of the ERAMs, and the drift distance.
...
import numpy as np
import scipy.special as sc # for the error function Erf
